<template>
  <div
      ref="menu"
      class="bg-white dark:bg-rightMenuColor"
      ...
      <template v-for="(item,index) of items">
        <template v-if="!item.hidden">
          <div
            ...
            <span class="menu_item_label line-through">{{ item.label }}</span>
          ...
          <div
            ...
            <span class="menu_item_label dark:text-white">{{ item.label }}</span>
            <div class="menu_item_expand_icon">▶</div>
          </div>
          <div
              :class="[
          ...
          <div class="border-t-2 border-gray-400 dark:border-gray-600 w-full" v-if="item.divided"></div>
        </template>
      </template>
    </div>
  </div>
